    ...
    <div className="descriptionbox">
      ...
      <div className="descriptionbox-description">
        <p>
          ...
          virtual marketplace where businesses and individ showcase their
          products, interact with customers, and conduc transactions without the
          need for a physical presence. E-com websites have gained immense
